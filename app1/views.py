...
from .models import Player, Fan, Staff, Match, Expenses, Revenue, News, Cart, Price, CreditCard, Merchandise, Purchases, Report, Streaming, LeaguesMen, LeaguesWomen
...
def leagues(request):
	...
	return render(request, 'leagues.html', { 'leaguemen':leaguemen, 'leaguewomen':leaguewomen})
...
def addmatch(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			Match.objects.create(id=next_id,team1=team1,team1_logo=team1_logo,team2=team2,team2_logo=team2_logo,date=date,location=location,priceA=priceA,priceB=priceB,priceC=priceC)
